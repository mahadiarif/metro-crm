    ...
    'resources' => [
        'services' => [
            ...
            'fields' => [
                ...
                'icon' => ['type' => 'text', 'label' => 'Icon (Heroicon name)'],
        ...
        'leads' => [
            ...
            'fields' => [
                ...
                'zone' => ['type' => 'text', 'label' => 'Zone/Territory'],
                'service_id' => [
                    'type' => 'select',
                ...
                'assigned_user' => [
                    'type' => 'select',
                    'label' => 'Assigned To',
                    'relationship' => 'assignedUser',
                    'option_label' => 'name',
                ],
                'existing_provider' => ['type' => 'text', 'label' => 'Existing Provider'],
                'current_usage' => ['type' => 'textarea', 'label' => 'Current Usage'],
            ],
        ],
        'visits' => [
