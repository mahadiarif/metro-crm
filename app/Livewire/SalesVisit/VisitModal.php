...
class VisitModal extends Component
{
     ...
     */
    public function mount($leadId = null, $isModalOpen = false, $isStandalone = false)
    {
        $this->leadId = $leadId;
    ...
    public function rules()
    {
        return [
            ...
            'serviceStatusesSelected' => 'required|array',
            // Profile fields
        ...
        if ($visitId) {
            ...
            foreach ($entry->serviceUsages as $svc) {
                $this->dynamicServices[] = [
                    ...
                    'competitor_name' => $svc->competitor,
                    'current_usage'   => $svc->details['value'] ?? '',
                ];
            }
        } elseif ($leadId) {
    ...
    public function saveVisit(LogSalesVisitAction $action)
    {
        ...
        $data = [
            ...
            'dynamic_services'    => $this->dynamicServices, // Passing for storage
        ];
